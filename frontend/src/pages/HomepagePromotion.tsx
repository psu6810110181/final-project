    ...
    <div className="bg-gray-50 min-h-screen pb-10">
      ...
      <div className="relative bg-gray-900 h-[400px] mb-8 overflow-hidden">
        ...
        <div className="absolute inset-0 container mx-auto px-4 flex flex-col justify-center text-white">
          <span className="bg-red-500 text-white px-3 py-1 rounded-full text-xs font-bold w-fit mb-4">HOT PROMOTION</span>
          <h1 className="text-4xl md:text-6xl font-bold mb-4">สินค้าโปรโมชัน <br/>สุดคุ้มแห่งปี</h1>
          <p className="text-gray-200 mb-8 max-w-lg">รวบรวมเฟอร์นิเจอร์ลดราคาพิเศษ ให้คุณแต่งบ้านสวยในราคาประหยัด</p>
        </div>
      </div>
