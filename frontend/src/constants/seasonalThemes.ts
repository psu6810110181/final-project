export interface SeasonalTheme {
  name: string;
  nameTh: string;
  themeIcon: string; // ✅ เปลี่ยนจาก emoji เป็น themeIcon
  gradient: string;
  animation: string;
  badgeColors: string;
...
export const seasonalThemes: Record<string, SeasonalTheme> = {
  spring: {
    name: 'Spring',
    nameTh: 'ฤดูใบไม้ผลิ',
    themeIcon: 'Flower', // ✅ ใช้ชื่อไอคอนจาก Lucide
  ...
  summer: {
    name: 'Summer',
    nameTh: 'ฤดูร้อน',
    themeIcon: 'Sun', // ✅ ใช้ชื่อไอคอนจาก Lucide
    ...
    description: 'สินค้าราคาพิเศษ สำหรับคุณเท่านั้น • พลาดไม่ได้ในฤดูร้อนนี้!',
    iconComponent: ['Sun', 'Waves', 'Sparkles']
  },
  autumn: {
    name: 'Autumn',
    nameTh: 'ฤดูใบไม้ร่วง',
    themeIcon: 'Leaf', // ✅ ใช้ชื่อไอคอนจาก Lucide
  ...
  winter: {
    name: 'Winter',
    nameTh: 'ฤดูหนาว',
    themeIcon: 'Snowflake', // ✅ ใช้ชื่อไอคอนจาก Lucide
    ...
    description: 'สินค้าราคาพิเศษ • อบอุ่นในฤดูหนาวนี้!',
